import 'package:dart_lessons/nesne_tabanli/composition/filmler.dart';
...
void main(){
  ...
  var f1 = new Filmler(film_id: 1, film_ad: "Django", film_yil: 2013, kategori: k1, yonetmen: y1);

  print("Film id : ${f1.film_id}");
  print("Film adi : ${f1.film_ad}");
